...
import { Image as ImageIcon, Loader2, MoreHorizontal, Send } from 'lucide-react'
		...
		<form onSubmit={onSubmit} className='pb-4 border-b'>
			...
			<section className='relative'>
				...
				<DropdownMenu modal>
					...
					<DropdownMenuContent>
						<div className='px-2 py-1 transition-all hover:bg-muted-foreground rounded-md hover:text-white cursor-pointer'>
							<input
								id='files'
								onChange={({ target }) => {
			...
			<div
				className='w-full flex justify-between px-4 mt-2 cursor-pointer'
