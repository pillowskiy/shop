...
const Product = forwardRef<HTMLDivElement, Object>((_, ref) => {
	return (
		<Card
			ref={ref}
			className='flex-card max-w-1/2 lg:max-w-1/3 xl:max-w-none shadow-md rounded-lg duration-500 bg-popover'
		>
			<Skeleton className='w-full h-[200px] object-cover rounded-t-lg' />
