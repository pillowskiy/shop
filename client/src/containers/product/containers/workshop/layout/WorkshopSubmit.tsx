...
const PRODUCT_ACTION_CONFIRM_BODY = {
    update: {
        ...
        description: "You are sure you want to update the product data? Old data will be lost!"
    },
    create: {
...
export const WorkshopSubmitButton: FC<WorkshopSubmitProps> = ({isProductExist, onConfirm}) => {
    return (
