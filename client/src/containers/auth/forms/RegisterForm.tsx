...
import {
	buildToast,
	useToast
} from '@layout/../../components/common/toast/useToast'
...
export const RegisterForm: FC = () => {
	...
	const [errors, setErrors] =
		useState<ApiValidationReject<RegisterBody>['errors']>(REGISTER_FIELDS)
		...
		<form onSubmit={onSubmit}>
			...
			<section className='mt-4'>
				<FormCheckbox className='opacity-70 mb-2'>
					Send me emails with information about promotions and interesting
					offers (optional)
				</FormCheckbox>
