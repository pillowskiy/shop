...
export const GeneralWorkShop: FC<GeneralWorkShopProps> = ({updateProduct, newProduct}) => {
    return (
        <Card className="relative row-span-2 bg-popover shadow-md px-4 py-2">
            ...
            <FormInput className="bg-white" placeholder="Product name" required/>
            ...
            />
            <p className="text-xs text-destructive">To publish a product, click on the switch above</p>

            <footer className="md:absolute bottom-0 w-full left-0 md:px-4 md:py-2">
                <hr className="my-2" />
                <Button>Save</Button>
                <Button className="ml-2" variant="destructive">Delete Product</Button>
            </footer>
        </Card>
    );
};